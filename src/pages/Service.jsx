...
function Service() {
    ...
    return (
        <div className='bg-gradient-to-t from-[#e52325e6] to-[#e5232500] h-[100vh] lg:h-[100vh]  pb-5 flex flex-col items-center justify-center gap-11'>
            <SiteLogo className='md:w-[13%] md:h-[24%] w-[50%]' />
            <div className=' flex flex-col md:gap-5  gap-2 w-[100%] px-[20px]  md:px-[20px] lg:px-[100px]'>
